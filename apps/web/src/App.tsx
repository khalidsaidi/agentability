...
function App() {
  ...
  return (
    <div className="relative min-h-screen">
      {/* Prevent background glows from creating a horizontal scrollbar without clipping content. */}
      <div className="pointer-events-none absolute inset-0 overflow-x-hidden">
        <div className="absolute left-0 top-10 h-64 w-64 -translate-x-1/3 rounded-full bg-primary/20 blur-3xl animate-float" />
        <div className="absolute right-0 top-40 h-80 w-80 translate-x-1/3 rounded-full bg-cyan-200/40 blur-3xl animate-float" />
